...
set_camera_ROI(objMicMan,[200 200 600 600]*2)
...
set_transmission_lamp_voltage(objMicMan,6)
...
imwrite(uint16(max(0,img)),sprintf('%s_%s.tif','DIC',timeStamp),'compression','none')
